...
const countries = [
   ...
   { country: "the Central African Republic", capital: "Bangui" },
   { country: "Chad", capital: "N'Djamena" },
   { country: "Chile", capital: "Santiago" },
   { country: "China", capital: "Beijing" },
   { country: "Colombia", capital: "Bogota" },
   { country: "Comoros", capital: "Moroni" },
   { country: "the Republic of the Congo", capital: "Brazzaville"},
   { country: "the Democratic Republic of the Congo", capital: "Kinshasa" },
   { country: "Costa Rica", capital: "San Jose" },
   { country: "(the) Cote d'Ivoire", capital: "Yamoussoukro" },
   { country: "Croatia", capital: "Zagreb"},
   // batch 2
   { country: "Cuba", capital: "Havana" },
   { country: "Cyprus", capital: "Nicosia" },
   { country: "the Czech Republic", capital: "Prague" },
   { country: "Denmark", capital: "Copenhagen" },
   { country: "Djibouti", capital: "Djibouti" },
   { country: "Dominica", capital: "Roseau" },
   { country: "the Dominican Republic", capital: "Santo Domingo" },
   ...
   { country: "Israel (proclaimed)", capital: "Jerusalem" },
   ...
   { country: "the Maldives", capital: "Male" },
   { country: "Mali", capital: "Bamako" },
   { country: "Malta", capital: "Valletta" },
   { country: "the Marshall Islands", capital: "Majuro" },
   ...
   { country: "the Seychelles", capital: "Victoria" },
   ...
   { country: "the United Arab Emirates", capital: "Abu Dhabi" },
   { country: "the United Kingdom", capital: "London" },
   { country: "the United States of America", capital: "Washington, D.C." },
