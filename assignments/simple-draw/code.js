drawFilledRect (0, 0, width, height, 'grey'); // use the red text to change the colors
var shithead = 1000
while (shithead >-150000) {
    drawLine(0, shithead, width, height, 'teal'); //do it here as well
