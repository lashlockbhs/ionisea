const attempts = 2000 //1 million is best - can go up to maybe 2 billion before crashing (will take about a minute at 1 billion)
const oddsIncrease = 0.1 // for testing (and funny) only! 1 = same numbers; 10 = 10x higher numbers;  0.1 = 10x lower
