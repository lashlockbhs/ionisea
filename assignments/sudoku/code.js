const attempts = 10000000 //1 million is best - can go up to maybe 2 billion before crashing (will take about a minute at 1 billion)
const mode = '3d3e4rf3' //'sci' or 'power'(anything else will return literal value)
const sciNote = (acc) => {
