...
const multiplier = 10 //this should not exceed a few million or things WILL break (also breaks with negatives)
const mode = 'vfvrg' //'sci', 'power', 'trunc', 'avg', 'commas', 'page.Crash()' (this will not do anything)
