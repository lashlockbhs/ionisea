...
const advancedPigLatin =(string)=>{ 
  ...
  return advlatin === 0? string.substring(advlatin,string.length)+string.substring(0)+'way':string.substring(advlatin, string.length)+string.substring(0, advlatin)+'ay'
