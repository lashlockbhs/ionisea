...
const advancedPigLatin =(string)=>{ 
  ...
  if (advlatin=0){
  return string.substring(advlatin+1,string.length)+string.substring(0,advlatin)+'way'
  }
  else{
    return string.substring(advlatin+1, string.length)+string.substring(0, advlatin)+'ay'
  }
}