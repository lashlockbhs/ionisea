...
if (winner[1] == 'h'){
  drawLine(width/2 - height/2,height*(winner[2]/3), width/2 + height/2, height*(winner[2]/3), 'black', 15)
} else if (winner[1] = 'v'){
  drawLine(width/2-height/2+height*(winner[2]/3),height, width/2-height/2+height*(winner[2]/3), 0, 'black', 15)
} else if (winner[1] = 'd'){
